...
const SeeOrders = () => {
  const boxIcon = "https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/e-commerce/boxIcon.svg"
    ...
    return (
<div className="md:p-10 !p-2 w-full !px-10 md:px-20 space-y-4 overflow-y-auto max-h-[90vh] ">            <h2 className="text-4xl  flex flex-col  gap-5 !font-medium !mb-5">My Orders </h2>
