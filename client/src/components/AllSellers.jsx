            ...
            <table className='w-full max-w-4xl bg-white border border-gray-200 text-xs sm:text-sm'>
                <thead>
                    <tr className='border-b border-gray-200'>
                        <th className='py-2 px-2 sm:px-4 text-left'>#</th>
                        <th className='py-2 px-2 sm:px-4 text-left'>Name</th>
                        <th className='py-2 px-2 sm:px-4 text-left hidden sm:table-cell'>Total Products</th>
                ...
                <tbody>
                    {sellers.map((seller, index) => (
                        <tr key={index} className='text-gray-700'>
                            <td className='py-2 px-2 sm:px-4 border-b text-center border-gray-200'>{index + 1}</td>
                            <td className='py-2 px-2 sm:px-4 border-b flex border-gray-200 mt-2'>
                                <span>{seller.name}</span>
                            </td>
                            <td className='py-2 px-2 sm:px-4 border-b hidden sm:table-cell border-gray-200'>{seller.totalproducts}</td>
