...
const Footer = () => {
  ...
  return (
    <>
      <div className="py-10 w-full min-h-[15vw] bg-white">
        {/* Top Features */}
        <div className="container w-full mx-auto pt-0 pb-10">
          <div className="flex flex-col md:flex-row items-center w-full h-full justify-center border-0 hover:border-blue-600 rounded-xl gap-6 md:gap-2">
            <div className="col group flex flex-col h-auto md:h-[10vw] items-center relative justify-center gap-2 w-full md:w-[25%] mb-6 md:mb-0">
              <LiaShippingFastSolid className="text-4xl md:text-5xl absolute left-1/2 top-5 group-hover:text-blue-600 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 group-hover:top-0" />
            ...
            <div className="col group flex flex-col h-auto md:h-[10vw] items-center relative justify-center gap-2 w-full md:w-[25%] mb-6 md:mb-0">
              <RiSecurePaymentLine className="text-4xl md:text-5xl absolute left-1/2 top-5 group-hover:text-blue-600 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 group-hover:top-0" />
              <h1 className="text-xl md:text-2xl font-semibold">Secure Payments</h1>
              <p className="text-sm text-center">UPI/Cards Accepted</p>
            </div>
            <div className="col group flex flex-col h-auto md:h-[10vw] items-center relative justify-center gap-2 w-full md:w-[25%] mb-6 md:mb-0">
              <BiSupport className="text-4xl md:text-5xl absolute left-1/2 top-5 group-hover:text-blue-600 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 group-hover:top-0" />
              <h1 className="text-xl md:text-2xl font-semibold">24/4 Support</h1>
              <p className="text-sm text-center">Contact Us Anytime</p>
            </div>
            <div className="col group flex flex-col h-auto md:h-[10vw] items-center relative justify-center gap-2 w-full md:w-[25%]">
              <GiReturnArrow className="text-4xl md:text-5xl absolute left-1/2 top-5 group-hover:text-blue-600 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 group-hover:top-0" />
        ...
        {/* Main Footer */}
        <div className="footer flex flex-col md:flex-row border-t-2 border-gray-400 shadow-md px-4 md:px-10 py-8 md:py-12 w-full">
          {/* Contact */}
          <div className="part1 w-full md:w-[30%] mb-8 md:mb-0">
          ...
          {/* Products & Company */}
          <div className="part2 w-full md:w-[40%] px-0 md:px-10 border-l-0 md:border-l-2 border-r-0 md:border-r-2 border-gray-400 flex flex-col md:flex-row gap-8">
          ...
          {/* Newsletter */}
          <div className="part3 w-full md:w-[30%] flex flex-col pl-0 md:pl-10 mt-8 md:mt-0">
            <h2 className="text-2xl md:text-3xl font-semibold mb-2">Subscribe To Newsletter</h2>
            ...
            <form className="mt-3">
              <input type="email" placeholder="Your Email Address" className="email w-full h-10 md:h-[3vw] border border-gray-300 focus:border-gray-700 outline-none px-4 rounded-sm" />
              <Button className="btn-org px-4 py-2 mt-3 w-full md:w-auto">
                Subscribe
              </Button>
        ...
        {/* Bottom Strip */}
        <div className="bottomStrip flex flex-col md:flex-row items-center justify-center py-3 mt-4">
