        ...
        <SwiperSlide>
          <div className="item w-full rounded-md overflow-hidden relative">
            ...
            <div className='
              ...
              w-full sm:w-[60%] md:w-[50%] 
              flex flex-col items-center justify-center 
              h-full px-4 py-6 sm:py-10 sm:px-10 
              bg-gradient-to-l from-black/70 via-black/40 to-transparent
              transition-all duration-1000
            '>
              <h1 className='text-lg sm:text-2xl md:text-[2.4vw] font-[500] text-left w-full text-white'>Big Saving Day</h1>
              <h2 className='text-2xl sm:text-4xl md:text-5xl font-[700] mt-2 sm:mt-5 text-white w-full text-left'>Women Solid Round Green T-shirt</h2>
              ...
              <div className='w-full mt-4'>
                <Button className='btn-org w-full sm:w-auto'>SHOP NOW</Button>
              </div>
            </div>
          </div>
        </SwiperSlide>
